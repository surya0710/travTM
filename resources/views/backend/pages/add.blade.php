            ...
            <div class="card-body">
              ...
              <form class="row g-3" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-6">
                    ...
                    <input type="text" name="slug" class="form-control" value="{{ old('slug') }}" id="inputUrl4">
                    <div class="text-danger">{{ $errors->first('slug') }}</div>
                </div>
                <div class="col-6">
                    <label for="inputMetaKeywords4" class="form-label">Meta Keywords</label>
                    <input type="text" name="meta_keywords" class="form-control" value="{{ old('meta_keywords') }}" id="inputMetaKeywords4">
                ...
                <div class="col-6">
                    ...
                    <textarea name="meta_description" class="form-control" id="inputMetaDescription4">{{ old('meta_description') }}</textarea>
